...
# dataset loader
parser.add_argument('--dataset', type=str, required=True, default='ETTh1', help='dataset type')
...
parser.add_argument('--batch_size', type=int, default=128, help='batch size of train input dataset')
