            ...
            for i, (batch_x, batch_y, batch_x_mark, batch_y_mark) in enumerate(vali_loader):
                ...
                if self.args.use_amp:
                    with torch.cuda.amp.autocast():
                        if 'Linear' in self.args.model or 'TS' in self.args.model or 'Mixer' in self.args.model or 'P_' in self.args.model:
                ...
                if f_dim == -1:
                    ...
                    batch_y[:, -self.args.pred_len:, f_dim:].to(self.device, non_blocking=True)
